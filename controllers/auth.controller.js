...
const checkLogin = require('../utilis/checkLogin');
...
exports.register = async (req, res) => {
    try {
        ...
        if ( login && typeof login ==='string' && checkLogin(login) && password && typeof password === 'string' && req.file && mobile && 
...
exports.login = async (req, res) => {
    try {
        ...
        if ( login && typeof login ==='string'  && checkLogin(login) && password && typeof password === 'string') {
